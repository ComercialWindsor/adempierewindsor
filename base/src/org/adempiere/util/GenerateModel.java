...
public class GenerateModel
{
	...
	public static void main (String[] args)
	{
		...
		log.info("----------------------------------");
		//	first parameter
		String directory = "D:/Aplicaciones/Desarrollo";
		if (args.length > 0)
			directory = args[0];
		...
		//	second parameter
		String packageName = "org.windsor.model";
		if (args.length > 1)
			packageName = args[1]; 
		...
		//	third parameter
		String entityType = "'U'";	//	User, Application
		if (args.length > 2)
			entityType = args[2]; 
		...
		tableLike = "'T_CuadroShopiFlow%'";	//	All tables
		...
		try
		{
			...
			{
				int id= rs.getInt(1);
				new ModelInterfaceGenerator(id, directory, packageName);
